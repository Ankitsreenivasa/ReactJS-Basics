...
function App() {
  ...
  const passwordGenerator = useCallback(() => {
    ...
    setpassword(pass);
  }, [length, setnumAllowed, setcharAllowed]);
  ...
  useEffect(() => {
    passwordGenerator()
  },[length,numAwllowed,charAwllowed,passwordGenerator])
      ...
      <div className="flex justify-center text-center">
        <div className="bg-gray-700 w-1/3 p-5 my-5 border-none rounded-lg">
          ...
          <div className="my-4 mt-8">
            ...
            />
            <button className="bg-orange-500 py-2 px-2 rounded-r-lg" onClick={copyPasswordToClipboard}>
              Copy
            </button>
          </div>
